...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">Cuentas por Cobrar </div>
                <div class="card-body">
                   
                    <div class="filters">
                     
                         <form action="/cxc" method="GET">
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                data-target="#paymentsModal" data-invoice="{{ $invoice->id}}">Abonos</a>
                                                <a class="dropdown-item" href="/cxc/{{ $invoice->id }}/payment"  data-toggle="modal"
