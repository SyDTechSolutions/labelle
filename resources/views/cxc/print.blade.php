...
<div class="container">
    <section class="card">
        ...
        <div id="invoice-company-details" class="row">
            ...
            <p class="pb-3"># {{ $invoice->consecutivo}}</p>
        ...
        <div id="invoice-items-details" class="pt-2">
            ...
            <div class="col-md-5 col-sm-12">
                ...
                <table class="table" style="font-size:12px;">
                    ...
                    <tr>
                        <td>Monto Cuenta</td>
                        <td class="text-right">{{ money($invoice->TotalComprobante) }}</td>
                    </tr>
                    <tr>
                        <td>Total Abonos</td>
        ...
        <div id="invoice-footer">
            ...
            <div class="col-md-5 col-sm-12 text-center">
                ...
                <a href="/cxc" class="btn btn-primary" role="button">Regresar a Cuentas por cobrar</a>
            </div>
            </div>
        </div>
        <!--/ Invoice Footer -->
