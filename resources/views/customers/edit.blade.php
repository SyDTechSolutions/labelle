 ...
 $(function () {
	...
	@if($customer)
	  	setTimeout(function(){
                ...
                $('#provincia option[value="{{ $customer->provincia }}"]').attr("selected", true);
                $('#provincia').change();
                $('#canton option[value="{{ $customer->canton }}"]').attr("selected", true);
			    $('#canton').change();
                $('#distrito option[value="{{ $customer->distrito }}"]').attr("selected", true);
                $('#distrito').change();
                // $('#barrio option[value="{{ $customer->barrio }}"]').attr("selected", true);
            }, 100);
	@endif
