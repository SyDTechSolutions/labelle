  ...
  font-family: 'Times New Roman';
    ...
    @media print{
     ...
     <div class="ticket">
        ...
        <br>{{ $setting->phone }}
        <br>{{ date("Y-m-d H:i:s") }}
        <br>{{ $proformapurchase->consecutivo }}
        <p>
          Creador: {{ Optional($proformapurchase->creator)->name }}
        </p>
        </p>
        <table>
        <thead>
        ...
        <tbody>
            ...
            <tr class="summary">
                ...
                <td class="precio">{{ money($proformapurchase->TotalVenta,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Descuentos</td>
                <td class="precio">{{ money($proformapurchase->TotalDescuentos,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Impuestos</td>
                <td class="precio">{{ money($proformapurchase->TotalImpuesto,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">TOTAL</td>
                <td class="precio">{{ money($proformapurchase->TotalComprobante + $proformapurchase->ajuste,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">AJUSTE</td>
                <td class="precio">{{ money($proformapurchase->ajuste,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">TOTAL CON AJUSTE</td>
                <td class="precio">{{ money($proformapurchase->TotalComprobante,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Pago con</td>
                <td class="precio">{{ money($proformapurchase->pay_with,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Cambio</td>
                <td class="precio">{{ money($proformapurchase->change,'¢',2) }}</td>
            </tr>
        </tbody>
        </table>
        <p class="centrado">¡GRACIAS POR SU COMPRA!
        <br>
        {{ $proformapurchase->observations }}
        <br>{{ $setting->notes }}</p>
    </div>
