        ...
        <table style="width:100%;">
            <tr>
                ...
                <td>
                    ...
                    ">
                        <li>Total</li>
                        <li class="lead text-bold-800">{{ money($TotalComprobante,'c') }}</li>
                    </ul>
                    </div>
                </td>
            </tr>
                        ...
                        <td>
                            <div class="col-md-5 col-sm-12">
                                ...
                                <table class="table" style="width:100%;">
                                    ...
                                    <!-- <tr>
                                        <td>Pago con</td>
                                        <td class="pink text-right" style="text-align:right;">{{ money($pay_with,'c') }}</td>
                                    </tr>
                                    <tr class="bg-grey bg-lighten-4">
                                        <td class="text-bold-800">Cambio</td>
                                        <td class="text-bold-800 text-right" style="text-align:right;">{{ money($change,'c') }}</td>
                                    </tr> -->
                                    </tbody>
                                </table>
                                </div>
