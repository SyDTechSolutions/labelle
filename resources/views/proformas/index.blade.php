        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                  <div class="level">
                        <span class="flex">Proformas</span>   
                        <div class="actions">
                ...
                <div class="card-body">
                    ...
                    <div class="filters">
                         ...
                         <form action="/proformas" method="GET">
                                <div class="row">
                                    <div class="col-sm-3">
                    ...
                    <a href="/proformas/create" class="btn btn-success btn-sm">Crear Proforma</a>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @foreach($proformas as $proforma)
                                ...
                                <tr>
                                    <th scope="row"><a href="/proformas/{{ $proforma->id }}">{{ $proforma->consecutivo }}</a></th>
                                    ...
                                    <td>
                                        @can('update', $proforma)
                                        <form method="POST" action="{{ url('proformas/'. $proforma->id) }}" data-confirm="Estas Seguro?">
                                            @csrf
                                            {{ method_field('DELETE')}}
