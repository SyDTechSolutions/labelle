  ...
  font-family: 'Times New Roman';
    ...
    @media print{
     ...
     <div class="ticket">
        ...
        <br>{{ $setting->phone }}
        <br>{{ date("Y-m-d H:i:s") }}
        <br>{{ $proforma->consecutivo }}
        <p>
          Vendedor: {{ Optional($proforma->creator)->name }}
        </p>
        </p>
        <table>
        <thead>
        ...
        <tbody>
            ...
            <tr class="summary">
                ...
                <td class="precio">{{ money($proforma->TotalVenta,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Descuentos</td>
                <td class="precio">{{ money($proforma->TotalDescuentos,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Impuestos</td>
                <td class="precio">{{ money($proforma->TotalImpuesto,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">TOTAL</td>
                <td class="precio">{{ money($proforma->TotalComprobante,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Pago con</td>
                <td class="precio">{{ money($proforma->pay_with,'¢',2) }}</td>
            </tr>
            <tr class="summary">
                <td class="cantidad"></td>
                <td class="producto">Cambio</td>
                <td class="precio">{{ money($proforma->change,'¢',2) }}</td>
            </tr>
        </tbody>
        </table>
...
<a class="oculto-impresion" href="/proformas/create">Regresar</a>
