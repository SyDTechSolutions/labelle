    ...
    <section class="card">
        ...
        <div id="invoice-company-details" class="row">
            ...
            <div class="col-md-6 col-sm-12 text-center text-md-right">
                <h2>Factura de regimen simplificado</h2>
        ...
        <div id="invoice-customer-details" class="row pt-2">
            ...
            <div class="col-md-6 col-sm-12 text-center text-md-left">
            <ul class="px-0 list-unstyled">
                <li class="text-bold-800">{{ $invoice->emisor }}</li>
                <li>{{ $invoice->email }}</li>
                @if($invoice->identificacion_emisor)
                <li>Identificación: {{ $invoice->identificacion_emisor }}</li>
                @endif
                @if($invoice->customer)
        ...
        <div id="invoice-items-details" class="pt-2">
            ...
            <div class="col-md-5 col-sm-12">
                ...
                <table class="table" style="font-size:12px;">
                    ...
                    <tr>
                        <td>Sub Total</td>
                        <td class="text-right">{{ money($invoice->TotalVenta) }}</td>
                    </tr>
                    <tr>
                        <td>Descuentos</td>
                        <td class="pink text-right text-danger">(-) {{ money($invoice->TotalDescuentos) }}</td>
                    </tr>
                    <tr>
                        <td>Impuestos (IVA)</td>
                        <td class="text-right">{{ money($invoice->TotalImpuesto) }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-bold-800 text-right"> {{ money($invoice->TotalComprobante) }}</td>
                    </tr>
                    <tr>
                        <td>Pago con</td>
                        <td class="pink text-right">{{ money($invoice->pay_with) }}</td>
                    </tr>
                    <tr class="bg-grey bg-lighten-4">
                        <td class="text-bold-800">Cambio</td>
                        <td class="text-bold-800 text-right">{{ money($invoice->change) }}</td>
                    </tr>
                    </tbody>
                </table>
                </div>
        ...
        <div id="invoice-footer">
            ...
            <div class="col-md-5 col-sm-12 text-center">
                ...
                <a href="/electronicinvoice" class="btn btn-primary" role="button">Regresar a facturación</a>
            </div>
            </div>
        </div>
        <!--/ Invoice Footer -->
