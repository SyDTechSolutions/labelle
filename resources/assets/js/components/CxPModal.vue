<template>
   <div class="modal fade" id="cxpModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="cxpModalLabel">Cuenta {{this.items.name}}</h4>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                               <tr v-for="(item, index) in items" :key="item.id">
                                    ...
                                    <th v-if="item.type === 'D'">{{ item.factura }}</th>
                                    <th v-else></th>
...
<script>
    ...
    export default {
        ...
        methods:{
            saldoTotal(){
                ...
                for(x in this.factura){
                     y+=this.factura[x].debito - this.factura[x].credito,'';
                }
                return y;
            },
            ...
            print(){
                ...
                window.open(`/purchases/${this.purchase}/cxp/print`,'name','width=1336,height=768');
            ...
            url(page){
                let url = `/purchases/${this.purchase}/cxp`;
        ...
        created(){ 
           ...
           window.events.$on('showCxpModal', (data) => {
               this.purchase = data;
               this.fetch()
           });
